...
import VTK3DViewport from './VTK3DViewport';
...
const mergeProps = (propsFromState, propsFromDispatch, ownProps) => {
  const { afterCreation } = propsFromState.layout.viewports[0];
...
const ConnectedVTK3DViewport = connect(
  mapStateToProps,
  mapDispatchToProps,
  mergeProps
)(VTK3DViewport);

export default ConnectedVTK3DViewport;
